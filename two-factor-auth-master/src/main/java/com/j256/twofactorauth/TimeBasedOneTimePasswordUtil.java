 ...
 * <li>Store the secret key in the database associated with the user account.
 * </li>
...
public class TimeBasedOneTimePasswordUtil {
	 ...
	 * 
	 * @param base32Secret
	 *            Secret string encoded using base-32 that was used to generate
	 *            the QR code or shared with the user.
	 * @param authNumber
	 *            Time based number provided by the user from their
	 *            authenticator application.
	 * @param windowMillis
	 *            Number of milliseconds that they are allowed to be off and
	 *            still match. This checks before and after the current time to
	 ...
	 *            See {@link #DEFAULT_TIME_STEP_SECONDS}.
	 * @return True if the authNumber matched the calculated number within the
	 *         specified window.
	 */
	...
	public static long generateNumber(String base32Secret, long timeMillis, int timeStepSeconds)
		...
		// take the 4 least significant bits from the encrypted string as an
		// offset
	 ...
	 * 
	 * @param keyId
	 *            Name of the key that you want to show up in the users
	 *            authentication application. Should already be URL encoded.
	 * @param secret
	 *            Secret string that will be used when generating the current
	 *            number.
	 */
	...
	/**
	 * Decode base-32 method. I didn't want to add a dependency to Apache Codec
